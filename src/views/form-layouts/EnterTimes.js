...
import { Box, FormControl, FormHelperText, InputLabel, MenuItem, Modal, Typography } from '@mui/material'
...
const EnterTimes = () => {
  ...
  const handleAddOpen=()=>setAddTeamOpen(true);
  const handleAddClose=()=>setAddTeamOpen(false);
  ...
  return (
      ...
      <CardContent>
        <form onSubmit={e => e.preventDefault()}>
          <Grid container spacing={5}>
            ...
            <Grid item xs={6} sm={4} >
            <Button onClick={handleAddOpen} type='submit' variant='contained' size='large'>
                Add Team
              </Button>
            </Grid>
            <Grid item xs={6} sm={4} >
    ...
    <Modal
      ...
      >
        <Box sx={style}>
          <Button onClick={handleAddClose} type='button' variant='contained' size='medium'>
            OK
          </Button>
        </Box> 
      </Modal>
